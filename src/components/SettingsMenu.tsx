    ...
    <div className="relative flex items-center">
      ...
      {showSettings && (
        ...
        <button
          ...
          className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-white/20 transition-all duration-300 shadow-lg hover:scale-110"
        >
